...
public class OrderFulfillmentService {
	...
	/*
	 * 1. Inventory service check order availability 2. Process payment for order 3.
	 * Notify to the user 3. Assign to vendor 4. packaging 5. assign delivery
	 * partner 6. assign trailer 7. dispatch product
	 **/

	public OrderDTO processOrder(OrderDTO order) throws InterruptedException {
